...
const leftWing: TAuditorium[] = [
  {
    ...
    section: SectionName.LEFT_WING1,
    id: "РИ-101",
  },
  {
    name: "Лестница",
...
const mainSection: TAuditorium[] = [
  {
    ...
    floor: 1,
    destination: GraphDestination.AUDITORIUM,
    section: SectionName.MAIN_SECTION1,
    entryOffset: 40,
    id: "РИ-127в",
  },
  {
  ...
  },
  {
    ...
    floor: 1,
    destination: GraphDestination.FOOD_CORT,
    section: SectionName.MAIN_SECTION1,
    entryOffset: 60,
    id: "РадиоТочка",
  },
  ...
  },
  {
    ...
    entry: Side.BOTTOM,
    neighbors: ["Коридор С/у 1floor", "Коридор РИ-124а"],
    floor: 1,
  ...
  },
  {
    ...
    entry: Side.RIGHT,
    neighbors: ["Коридор вендинговый автомат", "Коридор Лестница Слева 1floor"],
    linkedAuditoriums: [
  ...
  },
  {
    ...
    destination: GraphDestination.FOOD_CORT,
    section: SectionName.MAIN_SECTION1,
    id: "Вендинговый автомат справа 2",
  },
]
...
const rightWing: TAuditorium[] = [
  {
    ...
    floor: 1,
    destination: GraphDestination.LADDER,
    section: SectionName.RIGHT_WING1,
  ...
  },
  {
    ...
    entry: Side.LEFT,
    neighbors: ["Коридор РИ-135", "Коридор Лестница Справа 1floor"],
    floor: 1,
    destination: GraphDestination.AUDITORIUM,
    section: SectionName.RIGHT_WING1,
    id: "РИ-135",
...
export const neighborsGraph: TGraph[] = [
  ...
  },
  {
    ...
    section: SectionName.LEFT_WING1,
    floor: 1,
    linkedSection: [SectionName.MAIN_SECTION1],
  },
  {
    ...
    section: SectionName.MAIN_SECTION1,
    floor: 1,
    linkedSection: [SectionName.LEFT_WING1],
  },
  {
    id: "Коридор РИ-127г",
    destination: GraphDestination.CORRIDOR,
  ...
  },
  {
    ...
    height: 0,
    neighbors: [
      "Коридор вендинговый автомат",
      "Лестница Слева 1floor",
      "Буфет",
      "Коридор Буфет",
      "Вендинговый автомат слева",
    ],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    direction: Side.RIGHT,
    points: [548, 1450, 770, 1450],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
  },
  {
    id: "Коридор вендинговый автомат",
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: [
      "Коридор Лестница Слева 1floor",
  ...
  },
  {
    ...
    neighbors: [
      "Гардероб",
      "Коридор вендинговый автомат справа 1",
      "Вендинговый автомат справа 1",
      "Коридор гардероб налево",
      "Коридор вход наверх",
    ],
    direction: Side.RIGHT,
    points: [770, 1450, 1008, 1450],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
  },
  {
    id: "Коридор вендинговый автомат справа 1",
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: [
      "Коридор гардероб направо",
      "Вендинговый автомат справа 1",
      "Вендинговый автомат справа 2",
      "Коридор вендинговый автомат справа 2",
    ],
    direction: Side.RIGHT,
    points: [1008, 1450, 1068, 1450],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
  },
  {
    id: "Коридор вендинговый автомат справа 2",
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: [
      "Коридор вендинговый автомат справа 1",
      "Вендинговый автомат справа 2",
      "Коридор Фойе Справа 1floor",
    ],
    direction: Side.RIGHT,
    points: [1068, 1450, 1085, 1450],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
  },
  {
  ...
  },
  {
    ...
    destination: GraphDestination.TURN_OVER,
    height: 0,
    neighbors: ["Коридор РИ-138 направо", "Коридор Фойе Справа 1floor"],
    direction: Side.RIGHT,
    points: [1085, 1375, 1230, 1375],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
    linkedSection: [SectionName.RIGHT_WING1],
  },
  {
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Лестница Справа 1floor", "РИ-135", "Коридор РИ-135"],
    direction: Side.RIGHT,
...
export const configSectionsGraph: TGraph[] = [
  {
    id: SectionName.LEFT_WING1,
    destination: GraphDestination.SECTION,
    height: 0,
    neighbors: [SectionName.MAIN_SECTION1],
    direction: Side.RIGHT,
    points: [0, 0, 0, 0],
    section: SectionName.LEFT_WING1,
    floor: 1,
  ...
  {
    id: SectionName.MAIN_SECTION1,
    destination: GraphDestination.SECTION,
    height: 0,
    neighbors: [SectionName.LEFT_WING1, SectionName.RIGHT_WING1],
    direction: Side.RIGHT,
    points: [0, 0, 0, 0],
    section: SectionName.MAIN_SECTION1,
    floor: 1,
