...
const leftWing2: TAuditorium[] = [
  {
    ...
    section: SectionName.LEFT_WING2,
    entryOffset: 90,
    id: "РИ-201",
  },
  {
...
const mainSection2: TAuditorium[] = [
  {
    ...
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: SectionName.MAIN_SECTION2,
    entryOffset: 55,
    id: "РИ-217",
  },
  {
...
const rightWing2: TAuditorium[] = [
  {
    ...
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: SectionName.RIGHT_WING2,
    entryOffset: -30,
    id: "РИ-239",
  },
  {
...
export const neighborsGraphSecond: TGraph[] = [
  {
    ...
    section: SectionName.LEFT_WING2,
    floor: 2,
    linkedSection: [SectionName.MAIN_SECTION2],
  },

  {
    ...
    section: SectionName.MAIN_SECTION2,
    floor: 2,
    linkedSection: [SectionName.LEFT_WING2],
  },
  {
  ...
  },
  {
    ...
    section: SectionName.MAIN_SECTION2,
    linkedSection: [SectionName.RIGHT_WING2],
    floor: 2,
  },
  {
    id: "Коридор РИ-240",
...
export const configSectionsGraphSecond: TGraph[] = [
  {
    id: SectionName.LEFT_WING2,
    destination: GraphDestination.SECTION,
    height: 0,
    neighbors: [SectionName.MAIN_SECTION2],
    direction: Side.RIGHT,
    points: [0, 0, 0, 0],
    section: SectionName.LEFT_WING2,
    floor: 2,
  ...
  {
    id: SectionName.MAIN_SECTION2,
    destination: GraphDestination.SECTION,
    height: 0,
    neighbors: [SectionName.LEFT_WING2, SectionName.RIGHT_WING2],
    direction: Side.RIGHT,
    points: [0, 0, 0, 0],
    section: SectionName.MAIN_SECTION2,
    floor: 2,
