...
export const neighborsGraphFourth: TGraph[] = [
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор Лестница 4floor", "РИ-401", "Коридор РИ-402", "РИ-402"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор РИ-401", "РИ-402", "РИ-403", "РИ-404", "Коридор РИ-403"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-403", "РИ-404", "Коридор РИ-402", "РИ-405", "Коридор РИ-405"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-417", "Коридор РИ-415", "РИ-410", "Коридор РИ-415"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-412", "Коридор РИ-417", "РИ-419", "РИ-414", "Коридор РИ-419"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-419", "РИ-414", "Лестница 2 4floor", "Коридор РИ-412", "Коридор Лестница 2 4floor"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-421","Лестница 2 4floor", "Коридор РИ-419", "Коридор РИ-421"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-421","Коридор Лестница 2 4floor", "РИ-423", "Коридор РИ-423"],
    direction: Side.RIGHT,
