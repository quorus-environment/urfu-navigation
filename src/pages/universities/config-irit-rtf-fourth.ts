...
const leftWing4: TAuditorium[] = [
  ...
  },
  {
    ...
    entry: Side.LEFT,
    linkedAuditoriums: [{ floor: 1, id: "Лестница 2 1floor" }, { floor: 2, id: "Лестница 2 2floor" }, { floor: 3, id: "Лестница 2 3floor" }],
  ...
  },
  {
    ...
    entry: Side.RIGHT,
    neighbors: ["Коридор РИ-425", "Коридор Лестница Слева 4floor", "turnoverLeft4ToMain4"],
    floor: 4,
    destination: GraphDestination.AUDITORIUM,
    section: "leftWing4",
    id: "РИ-425",
  },
  {
    ...
    entry: Side.LEFT,
    linkedAuditoriums: [{ floor: 1, id: "Лестница Слева 1floor" }, { floor: 2, id: "Лестница Слева 2floor" }, { floor: 3, id: "Лестница Слева 3floor" }],
...
export const neighborsGraphFourth: TGraph[] = [
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-416", "turnoverLeft4ToMain4", "Коридор РИ-416"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["turnoverMain4ToLeft4", "Коридор РИ-423", "Коридор РИ-425"],
    direction: Side.RIGHT,
    points: [325, 1375, 350, 1375],
    section: "leftWing4mainSection4",
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-423", "Коридор РИ-421", "turnoverLeft4ToMain4", "Коридор РИ-425"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-425", "Коридор РИ-423", "turnoverLeft4ToMain4", "Коридор Лестница Слева 4floor"],
    direction: Side.RIGHT,
