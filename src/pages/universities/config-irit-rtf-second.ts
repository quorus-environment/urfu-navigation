...
const rightWing2: TAuditorium[] = [
  ...
  },
  {
    ...
    entry: Side.LEFT,
    neighbors: ["Коридор РИ-237", "Коридор РИ-238", "Коридор РИ-239"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "rightWing2",
    entryOffset: -50,
  },
  {
    ...
    entry: Side.LEFT,
    neighbors: ["Коридор РИ-239", "Коридор РИ-239а"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "rightWing2",
    entryOffset: -30,
...
export const neighborsGraphSecond: TGraph[] = [
  ...
  },
  {
    ...
    height: 0,
    neighbors: ["Лестница", "РИ-202", "Коридор РИ-202"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-202", "Коридор Лестница", "Коридор РИ-204", "РИ-204"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор РИ-215", "Лестница 2", "turnoverLeft2ToMain2"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["РИ-219", "Лестница Слева", "Коридор РИ-217"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор РИ-228 влево", "РИ-228", "С/у", "Коридор C/у"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Лестница Справа", "Коридор РИ-237"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор РИ-234", "РИ-235", "РИ-236", "turnoverMain2ToRight2"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Коридор РИ-235", "РИ-236"],
    direction: Side.RIGHT,
  ...
  },
  {
    ...
    destination: GraphDestination.CORRIDOR,
    height: 0,
    neighbors: ["Лестница 3", "РИ-250", "РИ-247", "Коридор РИ-247"],
    direction: Side.RIGHT,
