...
const mainSection2: TAuditorium[] = [
  ...
  },
  {
    ...
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-236", "Коридор С/у (ж) второй этаж"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section2",
  },
  {
    ...
    entry: Side.BOTTOM,
    neighbors: ["Коридор С/у (ж) второй этаж", "Коридор РИ-238"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section2",
  },
