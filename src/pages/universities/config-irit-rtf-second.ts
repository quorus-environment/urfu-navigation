...
const leftWing: TAuditorium[] = [
  ...
  },
  {
    ...
    coords: { x: 200, y: 50 },
    entry: Side.RIGHT,
    neighbors: ["Коридор Лестница", "Коридор РИ-203"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "leftWing1",
  },
  ...
  },
  {
    ...
    coords: { x: 200, y: 1000 },
    entry: Side.RIGHT,
    neighbors: ["Коридор РИ-220", "Коридор РИ-223", "Тех-помещение"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "leftWing1",
  },
  {
    ...
    coords: { x: 200, y: 1050 },
    entry: Side.RIGHT,
    neighbors: ["Лестница 2", "Коридор РИ-222", "Коридор РИ-225"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "leftWing1",
  },
  {
    ...
    coords: { x: 200, y: 1200 },
    entry: Side.RIGHT,
    neighbors: ["Коридор РИ-225", "turnoverLeftToMain"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "leftWing1",
  },
...
const mainSection: TAuditorium[] = [
  {
    ...
    coords: { x: 30, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["РИ-227г", "Коридор РИ-227г", "РИ-229б"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
  ...
  },
  {
    ...
    coords: { x: 140, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-229", "Коридор РИ-227а"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  {
    ...
    coords: { x: 30, y: 1350 },
    entry: Side.RIGHT,
    neighbors: ["РИ-227в", "РИ-229б", "Коридор РИ-227г"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  ...
  },
  {
    ...
    coords: { x: 30, y: 1400 },
    entry: Side.TOP,
    neighbors: ["РИ-227г", "Коридор РИ-227г", "РИ-227в"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
    entryOffset: 40,
  },
  {
    ...
    coords: { x: 140, y: 1400 },
    entry: Side.TOP,
    neighbors: ["Коридор РИ-227г", "Коридор РИ-229"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  ...
  },
  {
    ...
    coords: { x: 520, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-228", "Коридор РИ-226"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  {
    ...
    coords: { x: 570, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-228", "Коридор РИ-230"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  {
    ...
    coords: { x: 620, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-232", "Коридор РИ-230"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
  ...
  },
  {
    ...
    coords: { x: 720, y: 1250 },
    entry: Side.BOTTOM,
    neighbors: ["Коридор РИ-236", "Коридор РИ-234"],
    floor: 2,
    destination: GraphDestination.AUDITORIUM,
    section: "main_section",
  },
...
export const wallsSecond = [
  ...
  { x: 1280, y: 850, width: 50, height: 0, floor: 2 },
]
